 ...
 */
export function extractRelationships(content, knownEntities // entity name -> entity id
) {
    const relationships = [];
 ...
 */
export function extractAndResolveRelationships(content, entityResolver) {
 ...
 */
export function inferTypeFromContext(content, entityName) {
