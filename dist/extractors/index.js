...
export function extractEpisodic(content) {
    const entities = [];
    const topics = [];
...
export function extractSemantic(content) {
    const entities = [];
    const topics = [];
...
export function extractProcedural(content) {
...
export async function extract(content, context) {
    ...
    if (routing.episodic) {
        return {
            ...
            entities: entityResults.map((e) => e.text),
        };
    }
