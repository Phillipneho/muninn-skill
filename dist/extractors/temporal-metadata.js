...
function safeDateTimeFromObject(opts, fallback) {
    ...
    try {
        const dt = DateTime.fromObject(opts);
 ...
 */
export function getReferenceClock() {
    return DateTime.now();
}
 ...
 */
export function extractTemporalMetadata(text, referenceDate) {
 ...
 */
export function extractTemporalMetadataBatch(texts, referenceDate = new Date()) {
 ...
 */
export function resolveRelativeWithContext(text, contextEvents, referenceDate) {
...
//# sourceMappingURL=temporal-metadata.js.map