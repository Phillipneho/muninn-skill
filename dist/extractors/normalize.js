 ...
 */
export async function normalizeEntities(text, existingEntities, llmProvider) {
...
export function createAliasStore() {
    ...
    const canonicals = new Map(); // Store original case
    return {
 ...
 */
export async function extractWithNormalization(text, existingEntities, llmProvider) {
