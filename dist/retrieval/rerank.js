...
let rerankerModel = 'cross-encoder/ms-marco-MiniLM-L-6-v2';
/**
 ...
 */
export async function rerankWithCrossEncoder(query, documents, topK = 10) {
 ...
 */
export function lightweightRerank(query, documents, topK = 10) {
 ...
 */
export function setRerankerModel(model) {
    rerankerModel = model;
