 ...
 */
export async function findStaleImportantEntities(entityStore, options = {}) {
 ...
 */
export async function cohesionQuery(entityStore, relationshipStore, recallFn, options = {}) {
    const opts = { ...DEFAULT_OPTIONS, ...options };
 ...
 */
export async function simpleCohesionQuery(entityStore, relationshipStore, memories, options = {}) {
    const opts = { ...DEFAULT_OPTIONS, ...options };
    // Find stale-but-important entities
    const staleEntities = await findStaleImportantEntities(entityStore, opts);
    if (staleEntities.length === 0) {
 ...
 */
export function calculateSessionCohesion(currentSessionEntities, staleEntities) {
