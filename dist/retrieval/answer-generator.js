 ...
 */
export async function generateAnswer(query, memories, options) {
 ...
 */
export async function checkAnswerWithLLM(generated, expected, question, options) {
    const model = options?.model || OPENAI_MODEL;
    try {
        const response = await fetch('https://api.openai.com/v1/chat/completions', {
            method: 'POST',
 ...
 */
export async function generateAnswerWithCache(query, memories, options) {
 ...
 */
export async function checkAnswerWithCache(generated, expected, question, options) {
...
//# sourceMappingURL=answer-generator.js.map